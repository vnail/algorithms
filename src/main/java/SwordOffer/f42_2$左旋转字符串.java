...
import SwordOffer.Standard.StringUtils;
...
public class f42_2$左旋转字符串 {
    ...
    private static String leftRotateString(String str, int n) {
        ...
        f42_1$翻转单词顺序.Reverse(chars, 0, n-1);
        f42_1$翻转单词顺序.Reverse(chars, n, chars.length-1);
        f42_1$翻转单词顺序.Reverse(chars, 0, chars.length-1);
